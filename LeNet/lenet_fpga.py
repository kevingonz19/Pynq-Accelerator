...
conv1=Accelerator.Convolution2D(1,10,5,5,1,1,0,0,conv1_w,conv1_b,100000000)
conv2=Accelerator.Convolution2D(10,20,5,5,1,1,0,0,conv2_w,conv2_b,100000000)
pool1=Accelerator.Pool(2,2,2,2,'Max',0,1,100000)
